...
class AppColors {
  static const Color MAIN_COLOR = Color(0xFF38b6ff);
  static const Color MEATS = Color(0xFFC02828);
  static const Color DRUGSTORE = Color(0xFFC028BA);
  static const Color BAKERY = Color(0xFF28C080);
  static const Color SMISCELLANY = Color(0xFFC05D28);
